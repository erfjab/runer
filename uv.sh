...
readonly REPO_URL_WITH_TOKEN="https://${GITHUB_TOKEN}@github.com/${USERNAME}/${SCRIPT_NAME}.git"
...
clone_repo() {
    ...
    git clone "$REPO_URL_WITH_TOKEN" "$INSTALL_DIR/$SCRIPT_NAME" || error "Failed to clone repository"
